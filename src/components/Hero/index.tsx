        ...
        >
            <div className="flex flex-col gap-8 z-50">
                ...
                <p className='text-gray-200 max-w-[600px] leading-7'>
                    Findtalent.vn is a Professional Recruitment Agency in Vietnam. 
                    We are a qualified service offering total recruitment solutions 
                    from non-management to executive management level.
                </p>
